...
void setup()
{ //############## Aktuelle Labels an Maschiene sind korrekt ##############
...
void run()
{
  ...
  while (ftduino.input_get(Ftduino::I1)) // Lichtsensor 1 wartet auf Eingabe
    delay(1);
  delay(1200);
  ...
  while (ftduino.input_get(Ftduino::I4)) // Lichtsensor 2 wartet auf Eingabe
    delay(1);
  delay(2000);
